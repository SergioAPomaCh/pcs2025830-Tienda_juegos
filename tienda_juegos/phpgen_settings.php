...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Detalleorden', 'short_caption' => 'Detalleorden', 'filename' => 'detalleorden.php', 'name' => 'detalleorden', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Juegosfisicos', 'short_caption' => 'Juegosfisicos', 'filename' => 'juegosfisicos.php', 'name' => 'juegosfisicos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Ordenescompra', 'short_caption' => 'Ordenescompra', 'filename' => 'ordenescompra.php', 'name' => 'ordenescompra', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Recibos', 'short_caption' => 'Recibos', 'filename' => 'recibos.php', 'name' => 'recibos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
